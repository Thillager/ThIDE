...
public class Theme {
	...
	public static final Theme LIGHT = new Theme(
		...
		"light",
		"idea"                       // helles RSyntaxTextArea-Theme
	);
	...
	public static final Theme NORD = new Theme(
		...
		new Color(136, 192, 208),    // Nord-Blau als Accent
		new Color(163, 190, 140),    // Nord-Grün
		new Color(191, 97, 106),     // Nord-Rot
		new Color(76, 86, 106),
		new Color(46, 52, 64),
		"mac-dark",
		"dark"
	...
	public static final Theme MONOKAI = new Theme(
		...
		new Color(230, 219, 116),    // Monokai-Gelb
		new Color(166, 226, 46),     // Monokai-Grün
		new Color(249, 38, 114),     // Monokai-Pink
		new Color(70, 70, 60),
		new Color(39, 40, 34),
		"dark",
		"monokai"
	...
	public static final Theme SOLARIZED = new Theme(
		...
		new Color(181, 137, 0),      // Solar-Gelb
		new Color(133, 153, 0),      // Solar-Grün
		new Color(220, 50, 47),      // Solar-Rot
		new Color(7, 54, 66),
		new Color(0, 43, 54),
		"mac-dark",
		"dark"
	...
	public static final Theme[] ALL = { DARK, LIGHT, NORD, MONOKAI, SOLARIZED };
