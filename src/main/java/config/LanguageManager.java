...
public class LanguageManager {
	...
	static {
		...
		texts.put("DE_AboutDialog.headline", "ThIDE - Leichte Java IDE");
		texts.put("DE_AboutDialog.header", "Über ThIDE");
		...
		texts.put("EN_AboutDialog.headline", "ThIDE - Lightweight java IDE");
		texts.put("EN_AboutDialog.header", "About ThIDE");
		texts.put("EN_searchUpdates", "Search for updates");
		texts.put("EN_close", "Close");
		texts.put("EN_open", "Open");
		texts.put("En_format", "Format");
	}
